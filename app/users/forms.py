...
class LoginForm(Form):
    email = TextField("Email", validators=[DataRequired(message="You need to put in a username"), Length(min=4, message="Your username need to be at least 4 characters long.")])
...
class RegistrationForm(Form):
    email = TextField('Email', validators=[Length(min=4, max=25, message="Your username needs to be inbetween 4 and 25 chars")])
